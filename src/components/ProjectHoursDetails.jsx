...
const ProjectHoursDetails = ({
  ...
  const [selectedEmployeeScheduleId, setSelectedEmployeeScheduleId] = useState(null);
...
const employeeYearTotals = useMemo(() => {
  ...
  return totals;
}, [localEmployees, hiddenRows, inputValues, durations, normalizedFiscalYear, startDate]);
...
{shouldShowPriorYear() && (
  ...
  const uniqueKey = `${duration.monthNo}_${duration.year}`;
  return (
    <td key={`total-${uniqueKey}`} className="tbody-td text-center sticky bottom-0 text-xs font-bold bg-gray-200">
...
{showEmployeeSchedule && (
  <div className="mt-6 border-t-2 border-gray-300 pt-4">
    <div className="flex justify-between items-center mb-3">
      <h2 className="text-lg font-semibold text-gray-800">Employee Schedule</h2>
      <button
        onClick={() => setShowEmployeeSchedule(false)}
